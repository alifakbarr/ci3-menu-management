...
class Auth extends CI_Controller
{
    ...
    private function _login()
    {
        ...
        if ($user) {
            ...
            if ($user['is_active'] == 1) {
                ...
                $this->session->set_flashdata('msg', '<div class="alert alert-danger" role="alert">Email tidak aktif</div>');
                redirect('auth');
            }
        } else {
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() ==  false) {
            ...
            $this->session->set_flashdata('msg', '<div class="alert alert-success" role="alert">Registrasi berhasil</div>');
            redirect('auth');
        }
    }
